...
| [**WebGIS-Tech-Demo**](docs/webgis_architecture.md) | Docker-Stack: PostGIS, GeoServer (OGC), Angular mit OpenLayers **und** MapLibre, lokales Routing + Geocoding – inkl. Stolperstein-Sammlung |
