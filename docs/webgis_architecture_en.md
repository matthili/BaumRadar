...
On first run the script creates the `.env` **with random passwords**, builds the images and starts the stack. `CITY_FILTER` applies uniformly to the loader, routing **and** the geocoder.
