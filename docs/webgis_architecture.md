...
3. **Signaturprüfung ohne Krypto-Dependency**: Ed25519 steckt seit JDK 15 in der Standard-JCE (`KeyFactory.getInstance("Ed25519")`). Die App braucht BouncyCastle nur wegen alter Android-API-Level — der Loader nicht.
